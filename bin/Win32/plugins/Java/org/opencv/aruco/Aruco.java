...
public class Aruco {
    ...
    // C++: enum PatternPos (cv.aruco.PatternPos)
    public static final int
            ARUCO_CCW_CENTER = 0,
    ...
    //
    // C++:  void cv::aruco::estimatePoseSingleMarkers(vector_Mat corners, float markerLength, Mat cameraMatrix, Mat distCoeffs, Mat& rvecs, Mat& tvecs, Mat& objPoints = Mat(), Ptr_EstimateParameters estimateParameters = EstimateParameters::create())
    //
