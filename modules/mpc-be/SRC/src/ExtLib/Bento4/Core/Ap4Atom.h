...
// MP2
const AP4_Atom::Type AP4_ATOM_TYPE_MP2  = AP4_ATOM_TYPE('.','m','p','2');
...
const AP4_Atom::Type AP4_ATOM_TYPE_AVrp = AP4_ATOM_TYPE('A','V','r','p');
const AP4_Atom::Type AP4_ATOM_TYPE_R10g = AP4_ATOM_TYPE('R','1','0','g');
const AP4_Atom::Type AP4_ATOM_TYPE_R10k = AP4_ATOM_TYPE('R','1','0','k');
const AP4_Atom::Type AP4_ATOM_TYPE_r210 = AP4_ATOM_TYPE('r','2','1','0');
const AP4_Atom::Type AP4_ATOM_TYPE_b16g = AP4_ATOM_TYPE('b','1','6','g');
const AP4_Atom::Type AP4_ATOM_TYPE_b48r = AP4_ATOM_TYPE('b','4','8','r');
const AP4_Atom::Type AP4_ATOM_TYPE_b64a = AP4_ATOM_TYPE('b','6','4','a');
//
...
const AP4_Atom::Type AP4_ATOM_TYPE_XD5C = AP4_ATOM_TYPE('x','d','5','c');
...
const AP4_Atom::Type AP4_ATOM_TYPE_HapA = AP4_ATOM_TYPE('H','a','p','A');
const AP4_Atom::Type AP4_ATOM_TYPE_HapM = AP4_ATOM_TYPE('H','a','p','M');
