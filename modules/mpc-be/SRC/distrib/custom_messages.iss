...
de.AssociationFormatsAV=Dateizuordnungen für Video- und Audiodateien konfigurieren:
de.AssociationFormats=Dateizuordnungen für Video- und Audiodateien
de.AssociationVideo=Dateizuordnungen für Videodateien
de.AssociationAudio=Dateizuordnungen für Audiodateien
de.AssociationPlaylist=Dateizuordnungen für Wiedergabelisten
...
ru.AssociationVideo=Ассоциировать с видеофайлами
ru.AssociationAudio=Ассоциировать с аудиофайлами
ru.AssociationPlaylist=Ассоциировать с плейлистами
...
tr.AssociationFormatsAV=Video ve ses dosyaları ile ilişkilendirme ayarları:
tr.AssociationFormats=Video ve ses dosyalarıyla ilişkilendir
tr.AssociationVideo=Video dosyaları ile ilişkilendir
tr.AssociationAudio=Ses dosyaları ile ilişkilendir
tr.AssociationPlaylist=Oynatma listesi dosyaları ile ilişkilendir
tr.AutoPlayType=Oto oynat:
tr.AssociationMPCPlayCDAudioOnArrivalF=Ses CD oynat
tr.AssociationMPCPlayCDAudioS=Ses CD
